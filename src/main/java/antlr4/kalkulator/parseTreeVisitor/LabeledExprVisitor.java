...
public interface LabeledExprVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitCompare(LabeledExprParser.CompareContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitConditional(LabeledExprParser.ConditionalContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExponentiation(LabeledExprParser.ExponentiationContext ctx);
	/**
