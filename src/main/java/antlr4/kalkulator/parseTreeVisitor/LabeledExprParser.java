...
public class LabeledExprParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, MUL=4, DIV=5, ADD=6, SUB=7, POW=8, EQUAL=9, LESS=10, 
		GREATER=11, CONDITIONAL=12, COLON=13, ASSIGN=14, ID=15, INT=16, OTHER=17;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, "MUL", "DIV", "ADD", "SUB", "POW", "EQUAL", "LESS", 
			"GREATER", "CONDITIONAL", "COLON", "ASSIGN", "ID", "INT", "OTHER"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 98310L) != 0) );
			setState(11);
			match(EOF);
			}
		}
	...
	public static class CompareContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitCompare(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ConditionalContext extends ExprContext {
		...
		public TerminalNode CONDITIONAL() { return getToken(LabeledExprParser.CONDITIONAL, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitConditional(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public static class ExponentiationContext extends ExprContext {
		...
		public TerminalNode POW() { return getToken(LabeledExprParser.POW, 0); }
		public ExponentiationContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitExponentiation(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(34);
						((ExponentiationContext)_localctx).op = match(POW);
						setState(35);
						expr(6);
						}
						break;
					...
					case 5:
						...
						setState(46);
						((ConditionalContext)_localctx).op = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==CONDITIONAL || _la==COLON) ) {
							((ConditionalContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
